...
try:
    sql_script = open('add_crm_columns_to_roster.sql', encoding='utf-8').read()
except Exception as e:
    print(f"Error reading add_crm_columns_to_roster.sql: {e}")
    sys.exit(1)
...
if windows:
    ...
    print("SUCCESS: add_crm_columns_to_roster.sql executed in Supabase UI!")
else:
    print("WARNING: Supabase window not found. Please open Supabase dashboard SQL Editor in your browser, copy the contents of 'add_crm_columns_to_roster.sql', paste it, and run it.")
