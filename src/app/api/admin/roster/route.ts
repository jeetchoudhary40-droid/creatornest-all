...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const newCreator = {
      ...
      admin_updated_img: Boolean(img),
      admin_img_updated_at: img ? new Date().toISOString() : undefined,
      bio: bio || '',
...
export async function PUT(req: NextRequest) {
  ...
  try {
    ...
    creators[index] = {
      ...
      admin_updated_img: updates.img !== undefined ? true : (current.admin_updated_img ?? true),
      admin_img_updated_at: updates.img !== undefined ? new Date().toISOString() : (current.admin_img_updated_at || current.updated_at),
